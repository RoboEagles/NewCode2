...
public class RobotMap {
    ...
    public static double MIN_POT = 96; // TEST VALUE
    public static double RANGE = 30.0; // DEGREES
    
    public static void init() {
        // BEGIN AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTRUCTORS
        lifterliftPotentiometer = new AnalogPotentiometer(0, 300.0, 0.0);
        ...
        lifterArmExtension = new Solenoid(0, 4);
