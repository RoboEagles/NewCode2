 ...
 * E.G. BE LIKE KYLE
 */
public class Auto_HitDefense extends Command {
	...
	double startDistance = 0.,
			target_Distance = 0.,
			target_ChangeInDistance = 0.; 

    // BEGIN AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTRUCTOR
    public Auto_HitDefense() {
    ...
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=REQUIRES
    	...
    	target_ChangeInDistance = 60.0;	// INCHES
    	
    }
    
    public Auto_HitDefense(double distance) {
    	
    	target_ChangeInDistance = distance;
